...
# Ported from vLLM project (vllm/tests/tool_use/test_glm4_moe_tool_parser.py)
# Adapted for TabbyAPI with modified imports and fixtures
# ruff: noqa: E501
...
from endpoints.OAI.types.tools import Function, ToolCall


@pytest.fixture
def glm4_moe_tokenizer():
    """Create mock GLM tokenizer for tests."""
