...
class ReasoningParserManager:
    ...
    @classmethod
    def get_reasoning_parser(cls, name: str | None) -> type:
        """
...
def _is_list_of(obj, type_) -> bool:
    """Check if obj is a list of type_."""
    return isinstance(obj, list) and all(isinstance(item, type_) for item in obj)
